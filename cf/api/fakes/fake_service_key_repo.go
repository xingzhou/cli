...
func (f *FakeServiceKeyRepo) CreateServiceKey(instanceGuid string, serviceKeyName string) (apiErr error) {
...
func (f *FakeServiceKeyRepo) ListServiceKeys(instanceGuid string) (serviceKeys []models.ServiceKey, apiErr error) {
...
func (f *FakeServiceKeyRepo) GetServiceKey(instanceGuid string, serviceKeyName string) (serviceKey models.ServiceKey, apiErr error) {
	f.GetServiceKeyMethod.InstanceGuid = instanceGuid

	return f.GetServiceKeyMethod.ServiceKey, f.GetServiceKeyMethod.Error
}

func (f *FakeServiceKeyRepo) DeleteServiceKey(serviceKeyGuid string) (apiErr error) {
