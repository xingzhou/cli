...
var _ = Describe("delete-service-key command", func() {
	...
	Describe("requirements are satisfied", func() {
		Context("delete service key successfully", func() {
			BeforeEach(func() {
			...
			It("delete service key successfully with -f option", func() {
			...
			It("delete service key successfully without -f option and confirmed with yes", func() {
				requirementsFactory = &testreq.FakeReqFactory{LoginSuccess: true, ServiceInstanceNotFound: false, TargetedSpaceSuccess: true}
			...
			It("delete service key successfully without -f option and confirmed with no", func() {
				requirementsFactory = &testreq.FakeReqFactory{LoginSuccess: true, ServiceInstanceNotFound: false, TargetedSpaceSuccess: true}
		...
		Context("delete service key unsuccessful", func() {
			It("failed to delete service key when service instance does not exist", func() {
			...
			It("failed to delete service key when service key does not exist", func() {
